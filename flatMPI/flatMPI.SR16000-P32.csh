#!/usr/bin/csh
# Usage: submit ED general -largememory -jobtype parallel -n 32 -B -N -u t-nissie@imr.tohoku.ac.jp -exec fft_check_mpi.flatMPI.SR16000-P32.csh -J fft_check_mpi.flatMPI.SR16000-P32
##

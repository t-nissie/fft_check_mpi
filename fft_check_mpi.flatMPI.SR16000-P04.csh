#!/usr/bin/csh
# Usage: submit EB general -largememory -jobtype parallel -n 4 -B -N -u t-nissie@imr.tohoku.ac.jp -exec fft_check_mpi.flatMPI.SR16000-P04.csh -J fft_check_mpi.flatMPI.SR16000-P04
##
